    ...
    <div class="row">
    	...
    	<?= form_open('/voting_machine/consultar') ?>
                ...
                <div class="large-4 medium-4 columns">
                    ...
                    <input type="text" maxlength="9" size="9" placeholder="" name="codigo_centrovotacion" id="codigo_centrovotacion" value="<?php echo $mostrar_codigo_centrovotacion; ?>"  />
                </div>
               <div class="large-4 medium-4 columns">
                    <label><span style="color:red;">*</span> Numero de mesa</label>
                    <input type="text" maxlength="2" placeholder="" name="mesa" id="mesa" value="<?php echo $mostrar_mesa; ?>" />
                </div> 
